...
<script src="./templates/user/js/jquery-ui.min.js"></script>
<script src="./templates/user/js/jquery.countdown.min.js"></script>
<script src="./templates/user/js/jquery.nice-select.min.js"></script>
<script src="./templates/user/js/jquery.zoom.min.js"></script>
<script src="./templates/user/js/jquery.dd.min.js"></script>
<script src="./templates/user/js/jquery.slicknav.js"></script>
